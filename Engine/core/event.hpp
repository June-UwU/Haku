...
// Event Context data : the context data is based on the ioctl type of parameter for linux, the context data may be
// casted on to a pointer or used as itself and is a 64 bit signed int
...
constexpr const char* HK_EVENT_STRING[MAX_EVENT_CODES]{ "exit event",
														"key up event",
														"key down event",
														"mouse button event",
														"mouse move",
