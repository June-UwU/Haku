...
vulkan_pipeline::vulkan_pipeline(std::shared_ptr<vulkan_device>& device,std::shared_ptr<vulkan_renderpass>& renderpass, u32 width, u32 height, std::vector<std::shared_ptr<vulkan_shader>> shaders) 
    : device(device)
